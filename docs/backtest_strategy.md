...
- Menghasilkan kumpulan data perilaku sistem, nilai metrics  (`rls_health`, `parameter_deviations`, `dcc_metrics`, `kalman_metrics`) setiap entry di buat, filter mana yang paling merugikan / menguntungkan dan simpan metrics yang menguntungkan dan merugikan dalam parquet untuk bisa di gunakan dalam melatih model transformer
